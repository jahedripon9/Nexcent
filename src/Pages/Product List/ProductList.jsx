// Importing required assets and libraries
...
// Client logos array
const clientLogos = [
    { logo: logo1, alt: "Client Logo 1" }, // Object structure containing logo and alt text
    { logo: logo2, alt: "Client Logo 2" },
    { logo: logo3, alt: "Client Logo 3" },
    { logo: logo4, alt: "Client Logo 4" },
    { logo: logo5, alt: "Client Logo 5" },
    { logo: logo6, alt: "Client Logo 6" },
];
            ...
            <div className="grid grid-cols-12">
              ...
              <div className="col-span-12 md:col-span-8 pb-6 md:py-6 relative">
                ...
                <div className="px-6 lg:px-12 text-end flex items-center justify-start">
                  ...
                  <div className="mt-4">
                    <button className="text-xl font-semibold text-green-400">
                      Meet all customers
                    </button>
                    <FontAwesomeIcon
                      className="text-xl text-green-400 ps-2"
                      icon={faArrowRight}
                    />
                  </div>
                </div>
